...
Use sempre a tag de versão (`@v0.5.5`), nunca `@main` — a tag é imutável e não fica presa ao
...
**Carregue o kit UMA vez por página.** Duas URLs diferentes (`@main` + `@v0.5.5`, ou o
